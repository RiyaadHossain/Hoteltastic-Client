    ...
    <>
      {!success ? (
        <form onSubmit={handleSubmit}>
          <Typography sx={{ marginBottom: 5, fontSize: 20 }}>
            Please Pay Here To Confirm the Booking
          </Typography>
          ...
          <input
            name="email"
            required
            style={{ padding: 15, width: "100%", marginBottom: 4 }}
          ...
          <input
            name="phone"
            required
            style={{ padding: 15, width: "100%", marginBottom: 5 }}
            type="number"
          />
        ...
        <Box>
          ...
          <h2>
            You just booked{" "}
            <span style={{ color: "#2dbe6c" }}>{room?.propertyName}</span>!!
          </h2>
          <Typography>
            Your Transaction ID is :{" "}
            <span style={{ color: "#2dbe6c" }}>{tnxID}</span>
          </Typography>
          <Box
            sx={{
              display: "flex",
